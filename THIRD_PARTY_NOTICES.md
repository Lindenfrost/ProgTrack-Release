...
| --- | ---: | --- |
| Python runtime | 3.12 build environment | Python Software Foundation License |
...
| pyqtgraph | 0.14.0 | MIT; installed in the build environment and documented if bundled by future builds |

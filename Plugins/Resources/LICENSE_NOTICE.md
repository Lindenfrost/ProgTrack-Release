# ProgTrack Resource License Notice
...
The files in this folder are ProgTrack project resources. Unless a separate
...
- `Real_Sperma.xlsx`
- `Real_Urine.xlsx`
- `Reference_Weight_Infants_cj.txt`
- `SampleTrack_tissues_and_abbreviations.xlsx`
- `Species_List.txt`

...
PERM_CORE_MANAGE_INSTITUTION_SETTINGS = "core.manage_institution_settings"
...
PERM_HERITAGE_EDIT_GENOTYPE_COLORS = "heritage.edit_genotype_colors"
PERM_HERITAGE_DELETE_DURABLE_DUMMY = "heritage.delete_durable_dummy"
...
PERM_MEDI_EXPORT = "medi_track.export"
...
ALL_PERMISSIONS: List[str] = [
    ...
    PERM_CORE_MANAGE_INSTITUTION_SETTINGS,
    ...
    PERM_HERITAGE_VIEW, PERM_HERITAGE_EDIT_LINKS, PERM_HERITAGE_EDIT_GENOTYPE_COLORS,
    PERM_HERITAGE_DELETE_DURABLE_DUMMY,
    PERM_HERITAGE_EXPORT,
    PERM_MEDI_VIEW, PERM_MEDI_FILTER_USE, PERM_MEDI_EXPORT,
...
DEFAULT_JOB_BUNDLES: Dict[str, Set[str]] = {
    ...
    "manager": {
        ...
        PERM_PROJECT_UPLOAD_DOCUMENT, PERM_PROJECT_DELETE_DOCUMENT,
        PERM_PROJECT_UPLOAD_SOP, PERM_PROJECT_DELETE_SOP,
        PERM_MEDI_VIEW, PERM_MEDI_FILTER_USE, PERM_MEDI_DELETE_DOCUMENT, PERM_MEDI_ADD_DOCS,
        PERM_MEDI_EXPORT,
        PERM_CORE_STYLE_SETTINGS,
        PERM_CORE_MANAGE_INSTITUTION_SETTINGS,
        PERM_HERITAGE_EXPORT,
        PERM_HERITAGE_EDIT_GENOTYPE_COLORS,
        PERM_HERITAGE_DELETE_DURABLE_DUMMY,
        # Managers can open the scheduler for review; use/publish remains a
        # separate job-bundle permission.
        PERM_OP_SCHEDULER_VIEW,
        PERM_REPORTS_VIEW,
    },
    "researcher": {

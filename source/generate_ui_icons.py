...
ICONS: dict[str, str] = {
    ...
    "medi_ever_experiment": _svg('<path d="M26 7h12v8H26z" fill="#f7fafc" stroke="#25364a" stroke-width="4" stroke-linejoin="round"/><path d="M28 15v10L15 50a4 4 0 0 0 4 6h26a4 4 0 0 0 4-6L36 25V15z" fill="#f7fafc" stroke="#25364a" stroke-width="4" stroke-linejoin="round"/><path d="M24 7h16M28 15h8" fill="none" stroke="#25364a" stroke-width="4" stroke-linecap="round"/><circle class="blue" cx="47" cy="47" r="12"/><path d="M47 40v8l5 3" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round"/>'),
